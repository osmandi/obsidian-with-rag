...
print("\n\n") 
print("==== Embeddings section ========") 

# Set the embedding algorithm
embeddings = OpenAIEmbeddings(model="text-embedding-3-large")

# Store embeddings in a vector database - In-memory in this case
...
def search_documentation(query: str) -> str:
    ...
    Returns:
        File paths where trieved chunks were saved under /retrieved/.
    """
...
# Run the agent
EXAMPLE_QUERY = "How I can build a RAG?"
